                            ...
                            Expanded(
                              ...
                              child: Container(
                                ...
                                child: Obx(() => DropdownButtonFormField<String>(
                                  initialValue: controller.selectedFilter.value.isEmpty ? 'all' : controller.selectedFilter.value,
                                  isExpanded: true,
                                  dropdownColor: Colors.white,
                                  iconEnabledColor: const Color(0xFF199A8E),
                                  decoration: InputDecoration(
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.circular(16),
                                      borderSide: BorderSide.none,
                                  ...
                                  items: [
                                    ...
                                    DropdownMenuItem(value: 'today', child: Text('Today', style: TextStyle(color: Colors.black))),
                                    DropdownMenuItem(value: 'thisWeek', child: Text('This Week', style: TextStyle(color: Colors.black))),
                                    //DropdownMenuItem(value: 'thisMonth', child: Text('This Month', style: TextStyle(color: Colors.black))),
                                  ],
                                  onChanged: (value) {
