...
class _AdminDoctorVerificationPageState extends State<AdminDoctorVerificationPage> {
                    ...
                    return Column(
                      children: [
                        ...
                        Container(
                          ...
                          // Use Wrap so chips can wrap to next line on small widths (prevents overflow)
                          child: Wrap(
  ...
  Future<void> _updateDoctorVerification(String docId, String? userId) async {
    try {
      ...
      CustomSnackbar.showSuccess('Success', 'Doctor has been approved successfully!', context: context);
    } catch (e) {
      CustomSnackbar.showError('Error', 'Failed to approve doctor: $e', context: context);
    }
  }
}
