...
class _CategoryProductsPageState extends State<CategoryProductsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        // Ensure system back (Android) attempts to pop route properly.
        try {
          ...
          // ignore and allow Get to handle fallback
        }
        return true; // let the framework handle it
      },
      child: Scaffold(
            ...
            onPressed: () {
              try {
                if (Navigator.of(context).canPop()) {
                  ...
                  // fallback to Get.back() if Navigator cannot pop
                  Get.back();
                }
              } catch (e) {
                Get.back();
            ...
            child: Container(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFF199A8E).withAlpha(77)),
                ),
                child: TextField(
                        ...
                        Expanded(
                          child: ElevatedButton(
                            onPressed: () async {
                              ...
                              CustomSnackbar.showLight(
                                'Added to Cart',
                                '${data['name']?.toString() ?? 'Product'} has been added to your cart',
                              );
