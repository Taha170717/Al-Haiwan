      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          Get.to(
            () => DoctorChatScreen(
              chatId: chat.id,
              // doctor fields represent the doctor entity
              doctorName: chat.doctorName,
              doctorImage: chat.doctorImage,
              // participant fields should show the chat partner (doctor for the user)
              participantName: chat.doctorName,
              participantImage: chat.doctorImage,
            ),
          );
        },
      ),
