...
class DoctorProfileController extends GetxController {
  ...
  void initializeWeeklyAvailability() {
    weeklyAvailability.assignAll(daysOfWeek
  ...
  Future<bool> updateProfile() async {
    try {
      ...
      // Return success to let UI show the SnackBar with correct context
      return true;
    } catch (e) {
      // Log the error and return false so UI can respond
