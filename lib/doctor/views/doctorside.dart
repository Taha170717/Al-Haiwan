...
import 'package:al_haiwan/doctor/controller/doctor_notifications_controller.dart';
...
class _DoctorScreenState extends State<DoctorScreen> {
  ...
  // Notifications controller to expose unread count badge
  final DoctorNotificationsController notifController = Get.put(DoctorNotificationsController());
        ...
        actions: [
          ...
          Obx(() => IconButton(
            icon: Stack(
              ...
              children: [
                Icon(Icons.notifications_outlined, color: Color(0xFF199A8E)),
