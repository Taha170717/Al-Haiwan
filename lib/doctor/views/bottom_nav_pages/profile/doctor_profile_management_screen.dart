  ...
  Widget _buildSaveButton(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: () async {
          // Await the controller's updateProfile method which returns bool
          final success = await controller.updateProfile();

          // Show a beautiful custom SnackBar using ScaffoldMessenger
          ...
          if (success) {
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: const [
                            Text('Profile Saved', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                            SizedBox(height: 4),
                            Text('Your profile has been updated successfully.', style: TextStyle(color: Colors.white70, fontSize: 12)),
                          ],
                        ),
                      ),
                      TextButton(
            ...
            // wait briefly so user sees the snackbar, then navigate back to profile page
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: const [
                            Text('Save Failed', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                            SizedBox(height: 4),
                            Text('Failed to save profile. Please try again.', style: TextStyle(color: Colors.white70, fontSize: 12)),
                          ],
                        ),
                      ),
                      TextButton(
