...
class DoctorChatScreen extends StatefulWidget {
  final String chatId;
  // show the doctor as the chat participant
  final String doctorName;
  final String doctorImage;
  // the actual chat partner (participant) — this will be shown in the AppBar
        ...
        title: Row(
          children: [
            Container(
              ...
              child: ClipOval(
                // show the chat partner's image (participant)
                child: widget.participantImage.isNotEmpty
                    ? Image.network(
