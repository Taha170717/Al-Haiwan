                    ...
                    onTap: () async {
                      try {
                        ...
                        Get.to(
                            ...
                            // doctor fields should be the currently authenticated doctor
                            doctorName: FirebaseAuth.instance.currentUser?.displayName ?? '',
                            doctorImage: FirebaseAuth.instance.currentUser?.photoURL ?? '',
                          ),
                        );
                      } catch (e) {
